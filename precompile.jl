...
precompile(Tuple{getfield(Dataiku, Symbol("##list_projects#15")), Array{Any, 1}, typeof(Dataiku.list_projects)})
...
precompile(Tuple{getfield(Dataiku, Symbol("##create_dataset#56")), String, String, String, String, typeof(Dataiku.create_dataset), String, Dataiku.DSSProject})
...
precompile(Tuple{typeof(Base.getindex), Type{Union{Base.Missing, Float64}}, Float64, Float64, Base.Missing})
precompile(Tuple{Type{Base.Pair{A, B} where B where A}, Symbol, Array{Union{Base.Missing, Float64}, 1}})
precompile(Tuple{typeof(Base.getindex), Type{Union{Base.Missing, Int64}}, Int64, Int64, Base.Missing})
precompile(Tuple{Type{Base.Pair{A, B} where B where A}, Symbol, Array{Union{Base.Missing, Int64}, 1}})
precompile(Tuple{typeof(Base.getindex), Type{Union{Base.Missing, String}}, String, String, Base.Missing})
precompile(Tuple{Type{Base.Pair{A, B} where B where A}, Symbol, Array{Union{Base.Missing, String}, 1}})
precompile(Tuple{typeof(Base.getindex), Type{Union{Base.Missing, Bool}}, Bool, Bool, Base.Missing})
precompile(Tuple{Type{Base.Pair{A, B} where B where A}, Symbol, Array{Union{Base.Missing, Bool}, 1}})
precompile(Tuple{Type{Dates.DateTime}, Int64, Int64, Int64, Int64, Int64, Int64, Int64})
precompile(Tuple{typeof(Base.getindex), Type{Union{Base.Missing, Dates.DateTime}}, Dates.DateTime, Dates.DateTime, Base.Missing})
precompile(Tuple{Type{Base.Pair{A, B} where B where A}, Symbol, Array{Union{Base.Missing, Dates.DateTime}, 1}})
precompile(Tuple{Type{Base.Dict{K, V} where V where K}, Base.Pair{Symbol, Array{Union{Base.Missing, Float64}, 1}}, Vararg{Base.Pair{A, B} where B where A, N} where N})
precompile(Tuple{typeof(Base._compute_eltype), Type{Tuple{Base.Pair{Symbol, Array{Union{Base.Missing, Float64}, 1}}, Base.Pair{Symbol, Array{Union{Base.Missing, Int64}, 1}}, Base.Pair{Symbol, Array{Union{Base.Missing, String}, 1}}, Base.Pair{Symbol, Array{Union{Base.Missing, Bool}, 1}}, Base.Pair{Symbol, Array{Union{Base.Missing, Dates.DateTime}, 1}}}}})
precompile(Tuple{typeof(Base.grow_to!), Base.Dict{Any, Any}, Tuple{Base.Pair{Symbol, Array{Union{Base.Missing, Float64}, 1}}, Base.Pair{Symbol, Array{Union{Base.Missing, Int64}, 1}}, Base.Pair{Symbol, Array{Union{Base.Missing, String}, 1}}, Base.Pair{Symbol, Array{Union{Base.Missing, Bool}, 1}}, Base.Pair{Symbol, Array{Union{Base.Missing, Dates.DateTime}, 1}}}})
precompile(Tuple{Type{Base.Dict{K, V} where V where K}, Tuple{Base.Pair{Symbol, Array{Union{Base.Missing, Float64}, 1}}, Base.Pair{Symbol, Array{Union{Base.Missing, Int64}, 1}}, Base.Pair{Symbol, Array{Union{Base.Missing, String}, 1}}, Base.Pair{Symbol, Array{Union{Base.Missing, Bool}, 1}}, Base.Pair{Symbol, Array{Union{Base.Missing, Dates.DateTime}, 1}}}})
precompile(Tuple{Type{Base.Dict{Symbol, Array{Union{Base.Missing, Float64}, 1}}}})
precompile(Tuple{typeof(Base.empty), Base.Dict{Any, Any}, Type{Symbol}, Type{Array{Union{Base.Missing, Float64}, 1}}})
precompile(Tuple{typeof(Base.rehash!), Base.Dict{Symbol, Array{Union{Base.Missing, Float64}, 1}}, Int64})
precompile(Tuple{typeof(Base.ht_keyindex2!), Base.Dict{Symbol, Array{Union{Base.Missing, Float64}, 1}}, Symbol})
precompile(Tuple{typeof(Base.setindex!), Base.Dict{Symbol, Array{Union{Base.Missing, Float64}, 1}}, Array{Union{Base.Missing, Float64}, 1}, Symbol})
precompile(Tuple{typeof(Base.grow_to!), Base.Dict{Symbol, Array{Union{Base.Missing, Float64}, 1}}, Tuple{Base.Pair{Symbol, Array{Union{Base.Missing, Float64}, 1}}, Base.Pair{Symbol, Array{Union{Base.Missing, Int64}, 1}}, Base.Pair{Symbol, Array{Union{Base.Missing, String}, 1}}, Base.Pair{Symbol, Array{Union{Base.Missing, Bool}, 1}}, Base.Pair{Symbol, Array{Union{Base.Missing, Dates.DateTime}, 1}}}, Int64})
precompile(Tuple{Type{Base.Dict{Symbol, Array{T, 1} where T}}})
precompile(Tuple{typeof(Base.empty), Base.Dict{Symbol, Array{Union{Base.Missing, Float64}, 1}}, Type{Symbol}, Type{Array{T, 1} where T}})
...
precompile(Tuple{typeof(Base.setindex!), Base.Dict{Symbol, Array{T, 1} where T}, Array{Union{Base.Missing, Float64}, 1}, Symbol})
precompile(Tuple{typeof(Base.merge!), Base.Dict{Symbol, Array{T, 1} where T}, Base.Dict{Symbol, Array{Union{Base.Missing, Float64}, 1}}})
precompile(Tuple{typeof(Base.setindex!), Base.Dict{Symbol, Array{T, 1} where T}, Array{Union{Base.Missing, Int64}, 1}, Symbol})
precompile(Tuple{typeof(Base.grow_to!), Base.Dict{Symbol, Array{T, 1} where T}, Tuple{Base.Pair{Symbol, Array{Union{Base.Missing, Float64}, 1}}, Base.Pair{Symbol, Array{Union{Base.Missing, Int64}, 1}}, Base.Pair{Symbol, Array{Union{Base.Missing, String}, 1}}, Base.Pair{Symbol, Array{Union{Base.Missing, Bool}, 1}}, Base.Pair{Symbol, Array{Union{Base.Missing, Dates.DateTime}, 1}}}, Int64})
precompile(Tuple{typeof(Base.setindex!), Base.Dict{Symbol, Array{T, 1} where T}, Array{Union{Base.Missing, String}, 1}, Symbol})
precompile(Tuple{typeof(Base.setindex!), Base.Dict{Symbol, Array{T, 1} where T}, Array{Union{Base.Missing, Bool}, 1}, Symbol})
precompile(Tuple{typeof(Base.setindex!), Base.Dict{Symbol, Array{T, 1} where T}, Array{Union{Base.Missing, Dates.DateTime}, 1}, Symbol})
precompile(Tuple{typeof(Base.copyto!), Array{Symbol, 1}, Base.KeySet{Symbol, Base.Dict{Symbol, Array{T, 1} where T}}})
...
precompile(Tuple{typeof(Base.ht_keyindex), Base.Dict{Symbol, Array{T, 1} where T}, Symbol})
...
precompile(Tuple{getfield(DataFrames, Symbol("##DataFrame#109")), Bool, Type{DataFrames.DataFrame}, Base.Dict{Symbol, Array{T, 1} where T}})
...
precompile(Tuple{typeof(Base.copy), Array{Union{Base.Missing, Dates.DateTime}, 1}})
...
precompile(Tuple{getfield(Dataiku, Symbol("##write_dataframe#38")), Base.Iterators.Pairs{Symbol, Bool, Tuple{Symbol}, NamedTuple{(:infer_schema,), Tuple{Bool}}}, typeof(Dataiku.write_dataframe), Dataiku.DSSDataset, DataFrames.DataFrame})
...
precompile(Tuple{Type{Tables.Schema{(:c_bigint, :c_boolean, :c_date, :c_float, :c_string), Tuple{Union{Base.Missing, Int64}, Union{Base.Missing, Bool}, Union{Base.Missing, Dates.DateTime}, Union{Base.Missing, Float64}, Union{Base.Missing, String}}}}})
...
precompile(Tuple{typeof(Tables.columntable), Tables.Schema{(:c_bigint, :c_boolean, :c_date, :c_float, :c_string), Tuple{Union{Base.Missing, Int64}, Union{Base.Missing, Bool}, Union{Base.Missing, Dates.DateTime}, Union{Base.Missing, Float64}, Union{Base.Missing, String}}}, DataFrames.DataFrame})
precompile(Tuple{Type{NamedTuple{(:c_bigint, :c_boolean, :c_date, :c_float, :c_string), T} where T<:Tuple}, Tuple{Array{Union{Base.Missing, Int64}, 1}, Array{Union{Base.Missing, Bool}, 1}, Array{Union{Base.Missing, Dates.DateTime}, 1}, Array{Union{Base.Missing, Float64}, 1}, Array{Union{Base.Missing, String}, 1}}})
precompile(Tuple{typeof(Tables.rows), NamedTuple{(:c_bigint, :c_boolean, :c_date, :c_float, :c_string), Tuple{Array{Union{Base.Missing, Int64}, 1}, Array{Union{Base.Missing, Bool}, 1}, Array{Union{Base.Missing, Dates.DateTime}, 1}, Array{Union{Base.Missing, Float64}, 1}, Array{Union{Base.Missing, String}, 1}}}})
precompile(Tuple{typeof(Tables._types), Type{NamedTuple{(:c_bigint, :c_boolean, :c_date, :c_float, :c_string), Tuple{Array{Union{Base.Missing, Int64}, 1}, Array{Union{Base.Missing, Bool}, 1}, Array{Union{Base.Missing, Dates.DateTime}, 1}, Array{Union{Base.Missing, Float64}, 1}, Array{Union{Base.Missing, String}, 1}}}}})
...
precompile(Tuple{typeof(Tables.schema), Tables.RowIterator{NamedTuple{(:c_bigint, :c_boolean, :c_date, :c_float, :c_string), Tuple{Array{Union{Base.Missing, Int64}, 1}, Array{Union{Base.Missing, Bool}, 1}, Array{Union{Base.Missing, Dates.DateTime}, 1}, Array{Union{Base.Missing, Float64}, 1}, Array{Union{Base.Missing, String}, 1}}}}})
...
precompile(Tuple{getfield(CSV, Symbol("##write#54")), Bool, Bool, Array{String, 1}, typeof(CSV.write), Tables.Schema{(:c_bigint, :c_boolean, :c_date, :c_float, :c_string), Tuple{Union{Base.Missing, Int64}, Union{Base.Missing, Bool}, Union{Base.Missing, Dates.DateTime}, Union{Base.Missing, Float64}, Union{Base.Missing, String}}}, Tables.RowIterator{NamedTuple{(:c_bigint, :c_boolean, :c_date, :c_float, :c_string), Tuple{Array{Union{Base.Missing, Int64}, 1}, Array{Union{Base.Missing, Bool}, 1}, Array{Union{Base.Missing, Dates.DateTime}, 1}, Array{Union{Base.Missing, Float64}, 1}, Array{Union{Base.Missing, String}, 1}}}}, Base.BufferStream, CSV.Options{UInt8, UInt8, Dates.DateFormat{Symbol("yyyy-mm-ddTHH:MM:SS.sssZ"), Tuple{Dates.DatePart{Char(0x79000000)}, Dates.Delim{Char, 1}, Dates.DatePart{Char(0x6d000000)}, Dates.Delim{Char, 1}, Dates.DatePart{Char(0x64000000)}, Dates.Delim{Char, 1}, Dates.DatePart{Char(0x48000000)}, Dates.Delim{Char, 1}, Dates.DatePart{Char(0x4d000000)}, Dates.Delim{Char, 1}, Dates.DatePart{Char(0x53000000)}, Dates.Delim{Char, 1}, Dates.DatePart{Char(0x73000000)}, Dates.Delim{Char, 1}}}, Tuple{}}})
precompile(Tuple{getfield(CSV, Symbol("#kw##write")), NamedTuple{(:writeheader,), Tuple{Bool}}, typeof(CSV.write), Tables.Schema{(:c_bigint, :c_boolean, :c_date, :c_float, :c_string), Tuple{Union{Base.Missing, Int64}, Union{Base.Missing, Bool}, Union{Base.Missing, Dates.DateTime}, Union{Base.Missing, Float64}, Union{Base.Missing, String}}}, Tables.RowIterator{NamedTuple{(:c_bigint, :c_boolean, :c_date, :c_float, :c_string), Tuple{Array{Union{Base.Missing, Int64}, 1}, Array{Union{Base.Missing, Bool}, 1}, Array{Union{Base.Missing, Dates.DateTime}, 1}, Array{Union{Base.Missing, Float64}, 1}, Array{Union{Base.Missing, String}, 1}}}}, Base.BufferStream, CSV.Options{UInt8, UInt8, Dates.DateFormat{Symbol("yyyy-mm-ddTHH:MM:SS.sssZ"), Tuple{Dates.DatePart{Char(0x79000000)}, Dates.Delim{Char, 1}, Dates.DatePart{Char(0x6d000000)}, Dates.Delim{Char, 1}, Dates.DatePart{Char(0x64000000)}, Dates.Delim{Char, 1}, Dates.DatePart{Char(0x48000000)}, Dates.Delim{Char, 1}, Dates.DatePart{Char(0x4d000000)}, Dates.Delim{Char, 1}, Dates.DatePart{Char(0x53000000)}, Dates.Delim{Char, 1}, Dates.DatePart{Char(0x73000000)}, Dates.Delim{Char, 1}}}, Tuple{}}})
...
precompile(Tuple{typeof(CSV.writerow), Array{UInt8, 1}, Base.RefValue{Int64}, Int64, Base.BufferStream, Tables.Schema{(:c_bigint, :c_boolean, :c_date, :c_float, :c_string), Tuple{Union{Base.Missing, Int64}, Union{Base.Missing, Bool}, Union{Base.Missing, Dates.DateTime}, Union{Base.Missing, Float64}, Union{Base.Missing, String}}}, Tables.ColumnsRow{NamedTuple{(:c_bigint, :c_boolean, :c_date, :c_float, :c_string), Tuple{Array{Union{Base.Missing, Int64}, 1}, Array{Union{Base.Missing, Bool}, 1}, Array{Union{Base.Missing, Dates.DateTime}, 1}, Array{Union{Base.Missing, Float64}, 1}, Array{Union{Base.Missing, String}, 1}}}}, Int64, CSV.Options{UInt8, UInt8, Dates.DateFormat{Symbol("yyyy-mm-ddTHH:MM:SS.sssZ"), Tuple{Dates.DatePart{Char(0x79000000)}, Dates.Delim{Char, 1}, Dates.DatePart{Char(0x6d000000)}, Dates.Delim{Char, 1}, Dates.DatePart{Char(0x64000000)}, Dates.Delim{Char, 1}, Dates.DatePart{Char(0x48000000)}, Dates.Delim{Char, 1}, Dates.DatePart{Char(0x4d000000)}, Dates.Delim{Char, 1}, Dates.DatePart{Char(0x53000000)}, Dates.Delim{Char, 1}, Dates.DatePart{Char(0x73000000)}, Dates.Delim{Char, 1}}}, Tuple{}}})
precompile(Tuple{getfield(CSV, Symbol("#55#56")){Bool, Tables.Schema{(:c_bigint, :c_boolean, :c_date, :c_float, :c_string), Tuple{Union{Base.Missing, Int64}, Union{Base.Missing, Bool}, Union{Base.Missing, Dates.DateTime}, Union{Base.Missing, Float64}, Union{Base.Missing, String}}}, Tables.RowIterator{NamedTuple{(:c_bigint, :c_boolean, :c_date, :c_float, :c_string), Tuple{Array{Union{Base.Missing, Int64}, 1}, Array{Union{Base.Missing, Bool}, 1}, Array{Union{Base.Missing, Dates.DateTime}, 1}, Array{Union{Base.Missing, Float64}, 1}, Array{Union{Base.Missing, String}, 1}}}}, CSV.Options{UInt8, UInt8, Dates.DateFormat{Symbol("yyyy-mm-ddTHH:MM:SS.sssZ"), Tuple{Dates.DatePart{Char(0x79000000)}, Dates.Delim{Char, 1}, Dates.DatePart{Char(0x6d000000)}, Dates.Delim{Char, 1}, Dates.DatePart{Char(0x64000000)}, Dates.Delim{Char, 1}, Dates.DatePart{Char(0x48000000)}, Dates.Delim{Char, 1}, Dates.DatePart{Char(0x4d000000)}, Dates.Delim{Char, 1}, Dates.DatePart{Char(0x53000000)}, Dates.Delim{Char, 1}, Dates.DatePart{Char(0x73000000)}, Dates.Delim{Char, 1}}}, Tuple{}}, Tuple{Symbol, Symbol, Symbol, Symbol, Symbol}, Int64, Int64, Array{UInt8, 1}}, Base.BufferStream})
...
precompile(Tuple{getfield(Dataiku, Symbol("##_get_reading_schema#17")), Bool, typeof(Dataiku._get_reading_schema), Dataiku.DSSDataset, Array{Any, 1}})
...
precompile(Tuple{getfield(Dataiku, Symbol("##_get_reading_params#18")), String, Base.Iterators.Pairs{Union{}, Union{}, Tuple{}, NamedTuple{(), Tuple{}}}, typeof(Dataiku._get_reading_params), Dataiku.DSSDataset})
precompile(Tuple{getfield(Dataiku, Symbol("##get_dataframe#16")), Bool, Array{String, 1}, Array{String, 1}, Base.Iterators.Pairs{Union{}, Union{}, Tuple{}, NamedTuple{(), Tuple{}}}, typeof(Dataiku.get_dataframe), Dataiku.DSSDataset, Array{Any, 1}})
...
precompile(Tuple{getfield(Main, Symbol("#check_dataframe_values#3")), Base.Dict{Symbol, Array{T, 1} where T}, DataFrames.DataFrame})
precompile(Tuple{typeof(Base.length), CSV.Column{Union{Base.Missing, Dates.DateTime}, Union{Base.Missing, Dates.DateTime}}})
...
precompile(Tuple{typeof(Base.getindex), Array{Union{Base.Missing, Bool}, 1}, Int64})
...
precompile(Tuple{typeof(Base.length), Base.Dict{Symbol, Array{T, 1} where T}})
precompile(Tuple{typeof(Base.:(|>)), String, Type{T} where T})
precompile(Tuple{typeof(Base.haskey), Base.Dict{Symbol, Array{T, 1} where T}, Symbol})
precompile(Tuple{Type{Test.Returned}, Bool, Nothing, LineNumberNode})
precompile(Tuple{typeof(Base.getindex), Base.Dict{Symbol, Array{T, 1} where T}, Symbol})
