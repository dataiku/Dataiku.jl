...
precompile(Tuple{typeof(Base.merge_types), Tuple{Symbol, Symbol}, Type{NamedTuple{(:iofunction,), Tuple{getfield(Dataiku, Symbol("#7#8")){getfield(Dataiku, Symbol("#22#24")){Base.Channel{Any}, Array{String, 1}, Array{String, 1}, Array{Symbol, 1}, Nothing}}}}}, Type{NamedTuple{(:retry,), Tuple{Bool}}}})
precompile(Tuple{typeof(Base._compute_eltype), Type{Tuple{getfield(Dataiku, Symbol("#7#8")){getfield(Dataiku, Symbol("#22#24")){Base.Channel{Any}, Array{String, 1}, Array{String, 1}, Array{Symbol, 1}, Nothing}}, Bool}}})
...
precompile(Tuple{getfield(Dataiku, Symbol("##get_stream_read#6")), Base.Iterators.Pairs{Symbol, Base.Dict{String, Any}, Tuple{Symbol}, NamedTuple{(:params,), Tuple{Base.Dict{String, Any}}}}, typeof(Dataiku.get_stream_read), getfield(Dataiku, Symbol("#22#24")){Base.Channel{Any}, Array{String, 1}, Array{String, 1}, Array{Symbol, 1}, Nothing}, String})
...
precompile(Tuple{Type{NamedTuple{(:iofunction,), T} where T<:Tuple}, Tuple{getfield(Dataiku, Symbol("#7#8")){getfield(Dataiku, Symbol("#22#24")){Base.Channel{Any}, Array{String, 1}, Array{String, 1}, Array{Symbol, 1}, Nothing}}}})
precompile(Tuple{typeof(Base.merge), NamedTuple{(:iofunction,), Tuple{getfield(Dataiku, Symbol("#7#8")){getfield(Dataiku, Symbol("#22#24")){Base.Channel{Any}, Array{String, 1}, Array{String, 1}, Array{Symbol, 1}, Nothing}}}}, Base.Iterators.Pairs{Symbol, Bool, Tuple{Symbol}, NamedTuple{(:retry,), Tuple{Bool}}}})
precompile(Tuple{getfield(HTTP, Symbol("##stack#18")), Bool, Bool, Bool, Bool, Bool, Bool, Bool, Int64, Bool, Int64, Base.Iterators.Pairs{Symbol, getfield(Dataiku, Symbol("#7#8")){getfield(Dataiku, Symbol("#22#24")){Base.Channel{Any}, Array{String, 1}, Array{String, 1}, Array{Symbol, 1}, Nothing}}, Tuple{Symbol}, NamedTuple{(:iofunction,), Tuple{getfield(Dataiku, Symbol("#7#8")){getfield(Dataiku, Symbol("#22#24")){Base.Channel{Any}, Array{String, 1}, Array{String, 1}, Array{Symbol, 1}, Nothing}}}}}, typeof(HTTP.stack)})
...
precompile(Tuple{getfield(HTTP, Symbol("#kw##request")), NamedTuple{(:iofunction, :retry), Tuple{getfield(Dataiku, Symbol("#7#8")){getfield(Dataiku, Symbol("#22#24")){Base.Channel{Any}, Array{String, 1}, Array{String, 1}, Array{Symbol, 1}, Nothing}}, Bool}}, typeof(HTTP.request), String, String, Base.Dict{Any, Any}, Nothing})
precompile(Tuple{typeof(Base.merge_types), Tuple{Symbol, Symbol, Symbol}, Type{NamedTuple{(:reuse_limit,), Tuple{Int64}}}, Type{NamedTuple{(:iofunction, :retry), Tuple{getfield(Dataiku, Symbol("#7#8")){getfield(Dataiku, Symbol("#22#24")){Base.Channel{Any}, Array{String, 1}, Array{String, 1}, Array{Symbol, 1}, Nothing}}, Bool}}}})
precompile(Tuple{typeof(Base.merge_types), Tuple{Symbol, Symbol, Symbol}, Type{NamedTuple{(:require_ssl_verification,), Tuple{Bool}}}, Type{NamedTuple{(:iofunction, :retry), Tuple{getfield(Dataiku, Symbol("#7#8")){getfield(Dataiku, Symbol("#22#24")){Base.Channel{Any}, Array{String, 1}, Array{String, 1}, Array{Symbol, 1}, Nothing}}, Bool}}}})
precompile(Tuple{typeof(Base._compute_eltype), Type{Tuple{Bool, getfield(Dataiku, Symbol("#7#8")){getfield(Dataiku, Symbol("#22#24")){Base.Channel{Any}, Array{String, 1}, Array{String, 1}, Array{Symbol, 1}, Nothing}}, Bool}}})
precompile(Tuple{typeof(Base.merge_types), Tuple{Symbol, Symbol, Symbol}, Type{NamedTuple{(:iofunction, :retry), Tuple{getfield(Dataiku, Symbol("#7#8")){getfield(Dataiku, Symbol("#22#24")){Base.Channel{Any}, Array{String, 1}, Array{String, 1}, Array{Symbol, 1}, Nothing}}, Bool}}}, Type{NamedTuple{(:parent,), Tuple{HTTP.Messages.Response}}}})
precompile(Tuple{typeof(Base._compute_eltype), Type{Tuple{getfield(Dataiku, Symbol("#7#8")){getfield(Dataiku, Symbol("#22#24")){Base.Channel{Any}, Array{String, 1}, Array{String, 1}, Array{Symbol, 1}, Nothing}}, Bool, HTTP.Messages.Response}}})
...
precompile(Tuple{getfield(Dataiku, Symbol("#7#8")){getfield(Dataiku, Symbol("#22#24")){Base.Channel{Any}, Array{String, 1}, Array{String, 1}, Array{Symbol, 1}, Nothing}}, HTTP.Streams.Stream{HTTP.Messages.Response, HTTP.ConnectionPool.Transaction{Sockets.TCPSocket}}})
...
precompile(Tuple{getfield(Base, Symbol("##_#633")), Nothing, Bool, Type{Base.Channel{DataFrames.DataFrame}}, getfield(Dataiku, Symbol("#31#32")){Base.Iterators.Pairs{Union{}, Union{}, Tuple{}, NamedTuple{(), Tuple{}}}, Dataiku.DSSDataset, Int64, Array{Any, 1}}, Int64})
...
precompile(Tuple{getfield(Dataiku, Symbol("#31#32")){Base.Iterators.Pairs{Union{}, Union{}, Tuple{}, NamedTuple{(), Tuple{}}}, Dataiku.DSSDataset, Int64, Array{Any, 1}}, Base.Channel{DataFrames.DataFrame}})
precompile(Tuple{getfield(Base, Symbol("#634#635")){getfield(Dataiku, Symbol("#31#32")){Base.Iterators.Pairs{Union{}, Union{}, Tuple{}, NamedTuple{(), Tuple{}}}, Dataiku.DSSDataset, Int64, Array{Any, 1}}, Base.Channel{DataFrames.DataFrame}}})
